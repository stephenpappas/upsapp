...
<div class="col-md-8 col-md-offset-2">
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 class="panel-title">Edit Business Info</h3>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <input type="text" class="form-control" id="accountalpha" name="accountalpha" placeholder="Account Alpha" value="{{-- {{ $account->accountalpha }} --}}" readonly></input>
