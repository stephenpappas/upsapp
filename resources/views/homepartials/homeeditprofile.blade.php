        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <form class="form-horizontal" method="post" action="{{url('/home/editprofileconfirm')}} ">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" action="update" class="form-control" id="firstname" name="firstname" placeholder="firstname" value="{{ $user->firstname }}">
